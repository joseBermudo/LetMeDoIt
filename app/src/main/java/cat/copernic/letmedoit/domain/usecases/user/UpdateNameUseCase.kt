...
/**
 * Clase para el caso de actualizar el nombre del usuario
...
class UpdateNameUseCase @Inject constructor(
    ...
    /**
     * Método para invocar el caso de actualizar el nombre del usuario
     * @param newName nuevo valor del nombre del usuario
