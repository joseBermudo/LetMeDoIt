...
/**
 * Clase para el caso de actualizar el idioma del usuario
...
class UpdateLanguageUseCase @Inject constructor(
    ...
    /**
     * Método para invocar el caso de actualizar el idioma del usuario
     * @param language nuevo valor del idioma del usuario
