...
/**
 * Clase para el caso de actualizar el horario del usuario
...
class UpdateScheduleUseCase @Inject constructor(
    ...
    /**
     * Método para invocar el caso de actualizar el horario del usuario
     * @param schedule nuevo valor del horario del usuario
